...
<div>
    ...
    <i class="fa-regular fa-id-card input-group-text bg-success" style="color: white; padding-top: 10px;"></i>
    <input class="form-control" type="text" placeholder="Identificacion" name="Cedula" id="Cedula">
</div>
            ...
            <div class="input-group mt-2">
            <i class="fa-solid fa-square-envelope input-group-text bg-success" style="color: white;  padding-top: 10px;"></i>
