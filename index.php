...
<div>
    <div class="bg-white p-5 rounded-5 text-muted" style="width: 25rem">
        ...
        <form id="formlogin" class="form" action="" method="post">
            ...
            <!-- Campo adicional para nacionalidad -->
           

            <div class="d-flex align-items-center justify-content-center gap-1 mt-2">
                <a href="recuperar_contraseña.php" class="text-decoration-none text-success fw-bold fst-italic" style="font-size: 0.9rem">Olvidé mi contraseña</a>
            </div>
